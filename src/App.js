...
const navItems = [
  ...
  { id: "ecosystem", label: "REEP in Action" },
...
/* ─── REEP IN ACTION (Editorial Bento) ─── */
  ...
  return (
    <Section id="ecosystem">
      <div className="sec-head" data-testid="reep-in-action-section">
        <Eyebrow>REEP in Action</Eyebrow>
        <h2>On the ground at <span className="gradient-text">India's AI summits.</span></h2>
        <p className="lede">
          From the Bihar AI Summit 2026 to live VR and AI software demos — REEP shows up where India's
  ...
  return (
    <Section id="routing">
      ...
      <div className="startup-feature" data-testid="route-startup">
        <div className="startup-img-col">
          <img src="/media/software-presentation.jpeg" alt="Deep-tech solution presentation" loading="lazy" />
  ...
  return (
    <footer className="footer" data-testid="footer">
      <div className="footer-inner">
        ...
        <div>
          <h5>Navigate</h5>
          {[["home", "Home"], ["focus", "Focus Areas"], ["ecosystem", "REEP in Action"], ["leaders", "Leaders"], ["contact", "Contact"]].map(([id, label]) => (
